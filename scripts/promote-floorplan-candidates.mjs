...
function hasAcceptanceEvidence(candidate, visual) {
  ...
  if (/hirayakoubou\.net/.test(allSignal)) {
    if (/^(?:r?yew|yn|ys|rew|ms|ns|ew)-[0-9][a-z0-9_-]*fig(?:-\d+x\d+)?\.(?:jpe?g|png|webp)$/i.test(fileSignal) && visual.visualScore >= 0.45) return true;
    return false;
  }
