...
run("scripts/wordpress-rest-candidates.mjs", ["--config", "floorplan-growth.config.json", "--out", "data/candidate-images.jsonl"]);
run("scripts/pdf-floorplan-candidates.mjs", ["--input", "data/candidate-images.jsonl", "--review", "data/review-queue.jsonl", "--max-pdf-files", "100"]);
